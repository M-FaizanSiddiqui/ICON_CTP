...
$queryRec = "SELECT count(emp_id) as total_rec FROM employee WHERE emp_status = 0  AND emp_designation_id IN ('5')";
...
for($kj=0; $kj<$pageCount; $kj++){
	...
	$queryCheck = "SELECT * FROM employee WHERE emp_status = 0  AND emp_designation_id IN ('5') order by emp_id asc limit ".$limit." OFFSET ".$offset." ";
